...
JLLWrappers.@declare_library_product(libflac, "@rpath/libFLAC.14.dylib")
JLLWrappers.@declare_library_product(libflacpp, "@rpath/libFLAC++.11.dylib")
