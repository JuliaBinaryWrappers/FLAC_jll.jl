# Autogenerated wrapper script for FLAC_jll for armv7l-linux-musleabihf-cxx11
export flac, libflac, libflacpp, metaflac

using Ogg_jll
using CompilerSupportLibraries_jll
JLLWrappers.@generate_wrapper_header("FLAC")
JLLWrappers.@declare_library_product(libflac, "libFLAC.so.14")
JLLWrappers.@declare_library_product(libflacpp, "libFLAC++.so.11")
