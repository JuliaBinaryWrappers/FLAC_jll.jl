# Autogenerated wrapper script for FLAC_jll for i686-w64-mingw32-cxx11
export flac, libflac, libflacpp, metaflac

using Ogg_jll
using CompilerSupportLibraries_jll
JLLWrappers.@generate_wrapper_header("FLAC")
JLLWrappers.@declare_library_product(libflac, "libFLAC-14.dll")
JLLWrappers.@declare_library_product(libflacpp, "libFLAC++-11.dll")
